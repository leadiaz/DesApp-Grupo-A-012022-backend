...
public class TransactionsIntentionHandler {
    ...
    public TransactionsIntentionHandler() {
    }
    ...
    public static void createSaleTransactionIntention(CryptoAsset cryptoAsset, float amount, float price, float priceInArgentinianPesos, String userName) {
        TransactionIntention transactionSaleIntention = new TransactionIntention(cryptoAsset, amount, price,priceInArgentinianPesos,userName, TransactionIntention.OperationEnum.Venta);
